...
Data files are stored in folder 'Aswaraopet_fault_data', contains gravity anomaly, observation points and density distribution. User can use their own data for inverting any fault structure
...
%integral formula. For more detail go through Zhou 2008. It is same as poly_gravity function but for depth varying density contrast. 
	...
	f. FaultInvPSO.m is the main GUI file. 